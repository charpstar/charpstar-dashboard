...
function MiniAction({ children }: React.PropsWithChildren) {
  return (
    <Link
      href="/"
      type="button"
...
export default function AppSide() {
  return (
    ...
    >
      ...
      <div className="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-dark-tremor-background z-20">
        <MiniAction>
          <svg
            aria-hidden="true"
            className="w-6 h-6"
